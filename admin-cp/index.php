...
if(isset($_POST['login'])){
    ...
    $log="SELECT * FROM admin_panel WHERE admin_user='$unm' AND password='$pswd'";
...
<head>
    ...
    <title>Intensity - Fitness | Admin</title>
    <!-- Favicon-->
...
<body class="login-page">
    <div class="login-box">
        <div class="logo">
            <a href="javascript:void(0);">Intensity</a>
